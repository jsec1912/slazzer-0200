...
@font-face {
    font-family: 'icomoon';
    src: url('assets/fonts/icomoon.eot?1p26mg');
    src: url('assets/fonts/icomoon.eot?1p26mg#iefix') format('embedded-opentype'),
        url('assets/fonts/icomoon.ttf?1p26mg') format('truetype'),
        url('assets/fonts/icomoon.woff?1p26mg') format('woff'),
        url('assets/fonts/icomoon.svg?1p26mg#icomoon') format('svg');
    font-weight: normal;
    font-style: normal;
    font-display: block;
}
